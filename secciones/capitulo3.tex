...
\begin{landscape}
    \begin{table}[H]
        ...
        \begin{tabular}{|p{3cm}|p{1.2cm}|p{3cm}|p{2cm}|p{4.5cm}|p{3.5cm}|p{1.5cm}|}
            \hline
            \textbf{Modelo / Marca}                                        & \textbf{Canales}               & \textbf{Frecuencias}                                            & \textbf{Sensibilidad (dBm)}       & \textbf{Soporte de Seguridad (TLS/SSL)}                                & \textbf{Interfaces Backhaul}                      & \textbf{Precio (USD)}                \\ \hline
            RAK7268V2 (WisGate Edge Lite 2)                                & 8                              & AU915, US915, AS923, EU868, etc.                                & -139                              & Hardware (ATECC608) / Software                                         & Ethernet PoE, Wi-Fi, Celular (Opc)                & \$239.00                             \\ \hline
            Milesight UG63                                                 & 8                              & CN470, IN865, EU868, AU915, US915                               & -140                              & Software Avanzado (IPsec, OpenVPN)                                     & Ethernet, Celular (Opc)                           & \$270.00                             \\ \hline
            SenseCAP M2 Multi-Platform                                     & 8                              & IN865, EU868, AU915, US915, AS923                               & -139                              & Hardware (ECC608)                                                      & Ethernet PoE, Wi-Fi, Celular (Opc)                & \$199.00                             \\ \hline
            Dragino LPS8v2                                                 & 8                              & Pre-configurado globalmente (AU915, US915, EU868)               & -140                              & Software (Debian OS, OpenVPN)                                          & Ethernet WAN, Wi-Fi AP, Celular                   & \$170.00                             \\ \hline
            Heltec HT-M7603                                                & 8                              & 470$\sim$510MHz, 863$\sim$870MHz, 902$\sim$928MHz (Comp. AU/US) & -139                              & Software (Firmware ESP32)                                              & Ethernet LAN, Wi-Fi directa                       & \$89.00                              \\ \hline
            MikroTik wAP LoRa8 Kit                                         & 8                              & 863--870MHz, 902--928 MHz (Soporte AU915/US915)                 & -137                              & Software (RouterOS)                                                    & Ethernet PoE, Wi-Fi, Celular                      & \$169.00                             \\ \hline
            \cellcolor{green!15}\textbf{Gateway Personalizado (Propuesto)} & \cellcolor{green!15}\textbf{1} & \cellcolor{green!15}\textbf{Sub-GHz (915 MHz)}                  & \cellcolor{green!15}\textbf{-147} & \cellcolor{green!15}\textbf{Software (Firmware ESP32, MQTT sobre TLS)} & \cellcolor{green!15}\textbf{Wi-Fi (Nativo ESP32)} & \cellcolor{green!15}\textbf{\$48.68} \\ \hline
        \end{tabular}
    \end{table}
\end{landscape}
\FloatBarrier
