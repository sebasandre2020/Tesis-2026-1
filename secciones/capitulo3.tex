...
\begin{itemize}
    \item \textbf{Interacción y comunicación:} El gateway personalizado recibirá los datos de los sensores mediante comunicación LoRa y los enviará al backend alojado en Azure utilizando el protocolo MQTT a través de una conexión Wi-Fi.
    ...
    \item \textbf{Capacidad de procesamiento:} El gateway debe contar con los recursos computacionales suficientes para recibir las tramas LoRa, empaquetar los datos en formato JSON y gestionar el envío a los servicios en la nube (Azure Container Apps).
    ...
    \item \textbf{Recepción en Backend:} El backend debe estar configurado para recibir, autenticar y procesar los mensajes MQTT enviados por el gateway personalizado.
    \item \textbf{Almacenamiento y alertas:} Los datos recibidos deben almacenarse en la base de datos CosmosDB para su consulta histórica. Si las lecturas superan el umbral de CO\(_2\), el backend activará de inmediato el sistema de alertas.
\end{itemize}
