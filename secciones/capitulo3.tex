...
El controlador utiliza dos variables de entrada: el error de concentración de CO$_2$ y la variación del error. La salida corresponde a la señal de control aplicada a los ventiladores, expresada como porcentaje de PWM. El error se define como:

\begin{equation}
    e(k)=C_{CO_2}(k)-C_{ref}
\end{equation}

donde \(C_{CO_2}(k)\) representa la concentración medida de CO$_2$ en el instante \(k\), y \(C_{ref}\) corresponde al valor de referencia establecido. La variación del error se calcula como:

\begin{equation}
    \Delta e(k)=e(k)-e(k-1)
\end{equation}

Para la simulación, la variación del error también puede expresarse en ppm/min, con el objetivo de representar mejor la velocidad de cambio de la concentración:
