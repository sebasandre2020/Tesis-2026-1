...
\title{Diseño e implementación de un sistema IoT multivariable de monitoreo, alerta y control comparativo (CO\(_2\), material particulado, temperatura y humedad) para espacios universitarios, basado en comunicación LoRa mediante un gateway personalizado y despliegue en la nube}
...
\supervisor{Milenka Karolyn Gamero Tornero (ORCID: )} % Es obligatorio agregar ORCID del asesor
