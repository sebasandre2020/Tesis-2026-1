...
\title{Diseño e implementación de un sistema de monitoreo y alerta IoT para niveles de CO\(_2\) basado en comunicación LoRa con gateways personalizados y control predictivo de ventilación para espacios universitarios}
