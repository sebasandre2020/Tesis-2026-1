...
\title{Diseño e implementación de un sistema de monitoreo, control y alerta IoT para niveles de CO\(_2\) para espacios universitarios basado en comunicación LoRa empleando una arquitectura de red de topología estrella con un gateway personalizado}
